...
Because the LeRF scenes contain no COLMAP data, the data parser of the respective configuration has to be changed from the Colmap data parser to the Nerfstudio data parser in the `lerf\lerf_config.py` file prior to running evaluation.
