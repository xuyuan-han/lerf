...
class LERFPipelineConfig(VanillaPipelineConfig):
    ...
    datamanager: LERFDataManagerConfig = field(default_factory=LERFDataManagerConfig)
    """specifies the datamanager config"""
    model: ModelConfig = field(default_factory=LERFModelConfig)
    """specifies the model config"""
    network: BaseImageEncoderConfig = field(default_factory=BaseImageEncoderConfig)
